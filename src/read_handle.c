...
int mqtt3_packet_handle(struct mosquitto_db *db, struct mosquitto *context)
{
	...
	switch((context->in_packet.command)&0xF0){
		case PINGREQ:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PINGREQ..\n");
			return _mosquitto_handle_pingreq(context);
		case PINGRESP:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PINGRESP..\n");
			return _mosquitto_handle_pingresp(context);
		case PUBACK:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PUBACK..\n");
			return _mosquitto_handle_pubackcomp(db, context, "PUBACK");
		case PUBCOMP:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PUBCOMP..\n");
			return _mosquitto_handle_pubackcomp(db, context, "PUBCOMP");
		case PUBLISH:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PUBLISH..\n");
			return mqtt3_handle_publish(db, context);
		case PUBREC:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PUBREC..\n");
			return _mosquitto_handle_pubrec(context);
		case PUBREL:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command PUBREL..\n");
			return _mosquitto_handle_pubrel(db, context);
		case CONNECT:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command CONNECT..\n");
			return mqtt3_handle_connect(db, context);
		case DISCONNECT:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command DISCONNECT..\n");
			return mqtt3_handle_disconnect(db, context);
		case SUBSCRIBE:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command SUBSCRIBE..\n");
			return mqtt3_handle_subscribe(db, context);
		case UNSUBSCRIBE:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command UNSUBSCRIBE..\n");
			return mqtt3_handle_unsubscribe(db, context);
#ifdef WITH_BRIDGE
		case CONNACK:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command CONNACK..\n");
			return mqtt3_handle_connack(db, context);
		case SUBACK:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command SUBACK..\n");
			return _mosquitto_handle_suback(context);
		case UNSUBACK:
	_mosquitto_log_printf(NULL, MOSQ_LOG_INFO,"in_packet command UNSUBACK..\n");
